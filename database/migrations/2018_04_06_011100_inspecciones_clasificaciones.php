...
class InspeccionesClasificaciones extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inspecciones_clasificaciones', function (Blueprint $table) {
            $table->increments('id');
            $table->string('nombre');
    ...
    {
        Schema::dropIfExists('inspecciones_clasificaciones');
    }
}
