...
<br>
    ...
    <div class="container col-md-10">
        {{ Form::model($establecimiento, ['route' => ['establecimientos.update', $establecimiento], 'method' => 'post']) }}
            @method('put')
            ...
            <table class="container-fluid">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            {{ Form::select('edificio', $edificios, $establecimiento->ubicacion->edificio->id, ['required', 'class' => 'form-control']) }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            {{ Form::selectRange('piso', 1, 5, $establecimiento->ubicacion->piso , ['required', 'class' => 'form-control']) }}
                        </td>
                    </tr> 
                    <tr>
                        <th>
            ...
            <button type="submit" class="btn btn-primary">
                    <i class="fa fa-plus form-control-feedback"></i> Actualizar Establecimiento
            </button> 
