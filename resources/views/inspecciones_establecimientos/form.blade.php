<div class="container col-md-10">
    ...
    <div>
        <a role="button" class="btn btn-secondary" href="{{ route('inspecciones_establecimientos.index') }}">Cerrar</a>
        <input class="btn btn-primary" type="submit" value="{{ $bthText or 'Crear Inspección Establecimientos de Comida'}}" >
    </div>
</div>